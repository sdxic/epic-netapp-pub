...
# Part 1: Initial Setup Activities
1. On the lab jumpbox, launch the NTAP shortcut.  This shortcut will take you to the NetApp System Manager web interface.<br>![](images/part1_step1a.png)
<br>
...
#screenshot
    ...
    <br>
            * Verify that it_dept under network locations is showing the correct size.
    <br>
#screenshot
...
#screenshot
    <br>
            * Let's restore the file we deleted from a snapshot.  Right click on any open space in the it_dept network drive.
    <br>
