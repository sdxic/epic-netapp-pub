...
You will be required to create and modify some files during the course of this workshop.  You will not be required to write your own playbooks as this would require significantly more time.  
